...
import { PencilSquare, ShieldLockFill } from 'react-bootstrap-icons';

const Homework = () => {
	return (
		<div class='container'>
			<div class='py-5 text-center'>
				<PencilSquare size={48} />
				<h1>Solutions Portal</h1>
				<p class='lead'>
					{' '}
					You will be notified when your solution arrives via mail.
				</p>
			</div>
				...
				<div class='col-md-7 col-lg-8'>
					...
					<form class='needs-validation' novalidate>
						<div class='row g-3'>
							...
							<div class='col-sm-6'>
								<label for='Dealine' class='form-label'>
									Duration
								</label>
								<select class='form-select' id='course' required>
									<option>Within an hour</option>
									<option>Within the Day</option>
									<option defaultChecked>Within the Week</option>
								</select>
								<div class='invalid-feedback'>
									Please select a valid course.
								</div>
